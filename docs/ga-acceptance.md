...
| ACL-01 | Workspace, channel, user, profile, repository, tool, memory, and task authority are consistent at every transition. | Table-driven denial suite with audit records. | PENDING: Slack event/action, memory, and schedule workspace/user/profile/task denials pass; tool and isolation transitions remain |
