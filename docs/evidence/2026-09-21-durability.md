...
`bun run check` passed with 44 tests and one intentionally disabled live-T3 suite. The store, coordinator, interaction, service, memory, scheduler, ambient-policy, secret-scan, and Slack ingress fixtures proved:
