...
`bun run check` passed with 30 tests and one intentionally disabled live-T3 suite. The store, coordinator, interaction, service, and Slack ingress fixtures proved:
